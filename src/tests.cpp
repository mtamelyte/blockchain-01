...
int main()
{
    std::cout << "My hash: ";
    outputSizeTest(&hash);
    std::cout << "AI improved hash: ";
    outputSizeTest(&claudeHash);
    std::cout << "SHA256s: ";
    ...
    std::cout << "AI improved hash: ";
    determinismTest(&claudeHash);
    std::cout << "SHA256s: ";
    determinismTest(&sha256);
    std::cout << std::endl;
    std::cout << "Speed test (my hash): " << std::endl;
    speedTest(&hash);
    std::cout << "Speed test (AI improved hash): " << std::endl;
    speedTest(&claudeHash);
    std::cout << std::endl;
    ...
    std::cout << std::endl;
    std::cout << "Collision test (AI improved hash): " << std::endl;
    collisionTest(10, &claudeHash);
    collisionTest(100, &claudeHash);
    collisionTest(500, &claudeHash);
    collisionTest(1000, &claudeHash);
    std::cout << std::endl;
    ...
    avalancheTest(&hash);
    std::cout << std::endl;
    std::cout << "Avalanche test (AI improved hash): " << std::endl;
    avalancheTest(&claudeHash);
    std::cout << std::endl;
    ...
    saltTest(&hash);
    std::cout << std::endl;
    std::cout << "Salt test (AI improved hash): " << std::endl;
    saltTest(&claudeHash);
    std::cout << std::endl;
